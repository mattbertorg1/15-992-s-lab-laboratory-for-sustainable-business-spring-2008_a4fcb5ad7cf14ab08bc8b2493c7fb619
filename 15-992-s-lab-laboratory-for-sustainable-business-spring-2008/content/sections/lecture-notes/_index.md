...
menu:
  leftnav:
    identifier: 069753563c0020c38acc59cb09954204
    name: Lecture Notes
    weight: 40
title: Lecture Notes
type: course
uid: 069753563c0020c38acc59cb09954204
...
| SES # | TOPICS | DISCUSSIONS | SPEAKERS |
| --- | --- | --- | --- |
| {{< td-colspan 4 >}}**Framing the challenge**{{< /td-colspan >}} ||||
| {{< td-colspan 4 >}}**I. Introduction**{{< /td-colspan >}} ||||
| 1 | Course overview ([PDF]({{< baseurl >}}/sections/lecture-notes/lec_01)) | What does it mean for a private company to act "sustainably"?  {{< br >}}  {{< br >}}An introduction to the course and to the central challenge of sustainability. Sustainability, defined broadly to include social equity, economic development, and environmental restoration, offers new opportunities (but also challenges) for business. The management aspects are multi-faceted, and this course seeks to provide students with an overview of these issues.  {{< br >}}  {{< br >}}To frame our discussion, we will begin with a discussion of the Nike case.  {{< br >}}  {{< br >}}What are the risks and opportunities involved in sustainability-based business models? How are the different dimensions of sustainability related? How can organizations cope with the dynamic that things tend to get worse before they get better? | Locke; Lorrie Vogel, Manager, Nike "Considered" Brand |
| 2 | The state of the world ([PDF]({{< baseurl >}}/sections/lecture-notes/lec_02)) | Why is sustainability an important problem for business? A look at the science, and at the possible political and economic consequences of current trends. | Sterman |
| 3 | Organizational response ([PDF]({{< baseurl >}}/sections/lecture-notes/lec_03)) | An introduction to the problem of "worse before better" (WBB), overload, how firms overcome organizational barriers to move in new directions.  {{< br >}}  {{< br >}}Have you ever worked for an "overloaded" organization that was stuck in the kind of firefighting that Professor Repenning describes? Why were you stuck? Did the organization recover? If so, how?  {{< br >}}  {{< br >}}What are the major barriers to "going green" inside a for profit corporation? How can they best be overcome? | Henderson |
| {{< td-colspan 4 >}}**Framing a response**{{< /td-colspan >}} ||||
| {{< td-colspan 4 >}}**I. Get your own house in order**{{< /td-colspan >}} ||||
| 4 | Redefining traditional business models | How do companies build new business models, reform existing ones, and continue to perform in the marketplace? What are the costs and benefits for profit-seeking firms as they seek to embrace sustainability? How do they measure their impact?  {{< br >}}  {{< br >}}Through an examination of Brazil's Banco Real, we will explore the challenges and opportunities for companies as they embark on this change process. | Locke; Ricardo Marini, Banco Itau |
| 5 | Walking the talk: sustainability and new product development | How do companies translate sustainability (e.g., cradle to cradle design) into their product development and commercialization processes? How do they implement these practices and remain competitive in the marketplace? What happens when some of their goals (cutting edge design, commercial success, eco-efficiency) contradict? How do they resolve these dilemmas?  {{< br >}}  {{< br >}}We will explore these issues through a case discussion of the design firm, Herman Miller. | Locke |
| 6 | Sustainable retail. Can big box stores really go green? ([PDF]({{< baseurl >}}/sections/lecture-notes/lec_06)) | Walmart has made enormous investments in greening their facilities and in products.  {{< br >}}  {{< br >}}Can the world’s largest retailer make a real difference? Does their strategy selling green make sense? For whom? | Sterman |
| {{< td-colspan 4 >}}**II. Restructure the supply chain**{{< /td-colspan >}} ||||
| 7 | Ensuring sustainability along the supply chain | Walmart has made enormous investments in greening their facilities and in products.  {{< br >}}  {{< br >}}Can the world’s largest retailer make a real difference? Does their strategy selling green make sense? For whom? | Locke |
| 8 | Ensuring the sustainability of shared resources | Unilever looks at the collapse of the world's fisheries — how should they respond?  {{< br >}}  {{< br >}}What should Carl-Christian be sure to do this year? What must he accomplish? What are the critical issues he must address? How should he address them?  {{< br >}}  {{< br >}}Design an action plan listing his top five priorities as you see them, and give some thought as to the mechanisms you would use to tackle them. | Henderson |
| 9 | Social sustainability and labor standards | Following reports of child labor among some of its suppliers, Ikea came under enormous pressure from consumer groups and non-governmental organizations (NGOs).  {{< br >}}  {{< br >}}How should they respond? How effective is third party monitoring? How best can global corporations improve labor standards while respecting local socio-economic realities and cultures and defending their business models? | Locke |
